<template>
  <div id="cascade-and-specificity">
    ...
    <ModalImage src="cascade-specificity/css-terminology.png"></ModalImage>
    <p>
    ...
    <ModalImage src="cascade-specificity/what-is-cascade.png"></ModalImage>
    <p>
    ...
    <ModalImage src="cascade-specificity/css-order1.png"></ModalImage>
    <p>
    ...
    <ModalImage src="cascade-specificity/css-order2.png"></ModalImage>
    <p>But we should better look at an example, here right?</p>
    <ModalImage src="cascade-specificity/button-ex1.png"></ModalImage>
    <p>
    ...
    <ModalImage src="cascade-specificity/button-ex2.png"></ModalImage>
    <p>
    ...
    <h2>Specificity</h2>
    <ModalImage src="cascade-specificity/css-order3.png"></ModalImage>
    <p>
    ...
    <ModalImage src="cascade-specificity/button-ex3.png"></ModalImage>
    <p>
    ...
    <ModalImage src="cascade-specificity/button1.png"></ModalImage>
    ...
    <ModalImage src="cascade-specificity/button2.png"></ModalImage>
    ...
    <ModalImage src="cascade-specificity/button3.png"></ModalImage>
    ...
    <ModalImage src="cascade-specificity/button4.png"></ModalImage>
    <p>
    ...
    <ModalImage src="cascade-specificity/button5.png"></ModalImage>
    ...
    <ModalImage src="cascade-specificity/button6.png"></ModalImage>
    ...
    <ModalImage src="cascade-specificity/button7.png"></ModalImage>
    <p>
    ...
    <ModalImage src="cascade-specificity/css-order4.png"></ModalImage>
    <p>
    ...
    <h3 class="list-item">A selector that contains 1 ID is more specific than one with 1000 classes</h3>
