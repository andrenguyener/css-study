<template>
	<div id="behind-the-scenes">
		...
		<ModalImage src="behind-the-scenes-diagram/step1.png"></ModalImage>
		<p>It then takes the loaded HTML code and parses it, which basically means it decodes the code line by line.</p>
		<ModalImage src="behind-the-scenes-diagram/step2.png"></ModalImage>
		...
		<ModalImage src="behind-the-scenes-diagram/step3.png"></ModalImage>
		...
		<ModalImage src="behind-the-scenes-diagram/step4.png"></ModalImage>
		<p>CSS also is parsed but parsing of CSS is a bit more complex. I will talk about this in greater details later.</p>
		<ModalImage src="behind-the-scenes-diagram/step5.png"></ModalImage>
		...
		<ModalImage src="behind-the-scenes-diagram/step8.png"></ModalImage>
		<p>These together form the so-called render tree and with that we finally have everything we need to render the page.</p>
		<ModalImage src="behind-the-scenes-diagram/step9.png"></ModalImage>
		...
		<ModalImage src="behind-the-scenes-diagram/step10.png"></ModalImage>
